...
function checkRoles({
    roles,
    expectedImpostorCount,
    expectedDetectivesCount,
    expectedMedicsCount,
    expectedJesterCount,
    expectedCrewmatesCount,
}) {
    expect(roles[Role.IMPOSTOR]).toBe(expectedImpostorCount);
    ...
    expect(roles[Role.CREWMATE]).toBe(expectedCrewmatesCount);
}
